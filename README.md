...
* **Fonts:** [Poppins](https://fonts.google.com/specimen/Poppins) (for a modern, clean look).

## ✨ Key Features
* **Global Design System:** Centralized `theme.css` managing colors and typography across the entire site.
* **Responsive UI:** Optimized for various screen sizes, from mobile to desktop.
